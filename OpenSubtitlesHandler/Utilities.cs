...
namespace OpenSubtitlesHandler
{
    ...
    public static class Utilities
    {
        ...
        public static async Task<(Stream, int?, HttpStatusCode)> SendRequestAsync(byte[] request, string userAgent, CancellationToken cancellationToken, HttpStatusCode[] allowedStatusCodes = null)
        {
            ...
            var result = await HttpClient.Post(options, allowedStatusCodes).ConfigureAwait(false);
